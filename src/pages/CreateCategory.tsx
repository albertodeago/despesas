...
import { ExpenseCategoryApi, ExpenseGroup, ExpenseGroupId } from "../api";
  ...
  const createCategory = async (params: {
    ...
    try {
      await ExpenseCategoryApi.create(
        Object.assign({}, params, { ownerId, groupId: params.groupId })
      );
    ...
    <div>
      ...
      <div>
        ...
        <input
          ...
          value={keywords}
          onChange={(e) =>
            setKeywords(e.target.value.split(",").map((a) => a.trim()))
          }
        />
      </div>
      <div>
